...
<body>
    <main class="h-screen w-full flex items-center justify-center">
        <form action="salvar.php" method="post" class="flex items-center justify-center flex-col gap-8">
            <div>
                <h2 class="text-3xl">Login - SysFitness</h2>
            </div>
            <div>
            ...
            <div>
                <button type="submit" class="py-2 px-4 bg-violet-600 text-white rounded">Entrar</button>
            </div>
            <div>
                <p>Não tem uma conta? <a href="cadastrar.php" class="font-bold text-violet-600">Criar conta</a></p>
            </div>
        </form>
    </main>
</body>
